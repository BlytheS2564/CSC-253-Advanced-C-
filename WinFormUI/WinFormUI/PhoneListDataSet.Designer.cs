...
namespace WinFormUI {
    ...
    public partial class PhoneListDataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public TableRow FindByPersonID(int PersonID) {
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public int PersonID {
                get {
                    return ((int)(this[this.tableTable.PersonIDColumn]));
                }
                set {
                    this[this.tableTable.PersonIDColumn] = value;
                }
            }
...
namespace WinFormUI.PhoneListDataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([PersonID] = @Original_PersonID) AND ([Name] = " +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Name], [Phone]) VALUES (@Name, @Phone);\r\nSELECT Perso" +
                "nID, Name, Phone FROM [Table] WHERE (PersonID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Table] SET [Name] = @Name, [Phone] = @Phone WHERE (([PersonID] = @O" +
                "riginal_PersonID) AND ([Name] = @Original_Name) AND ([Phone] = @Original_Phone))" +
                ";\r\nSELECT PersonID, Name, Phone FROM [Table] WHERE (PersonID = @PersonID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WinFormUI.Properties.Settings.Default.PhoneListConnection;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT PersonID, Name, Phone FROM dbo.[Table]";
        ...
        public virtual int Fill(PhoneListDataSet.TableDataTable dataTable) {
        ...
        public virtual PhoneListDataSet.TableDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            PhoneListDataSet.TableDataTable dataTable = new PhoneListDataSet.TableDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(PhoneListDataSet.TableDataTable dataTable) {
